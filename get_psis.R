  ...
  ggplot(col_nfam_sum, aes(x = avg_cost_sc, fill = nfam_code)) + geom_histogram(bins = 100) + 
    ...
    theme_bw() + 
    scale_fill_manual(values = c(med_purple, med_green, dark_lilac, dark_cream, med_red, med_yellow)) + 
    scale_color_manual(values = c(med_purple, med_green, dark_lilac, dark_cream, med_red, med_yellow)) + 
